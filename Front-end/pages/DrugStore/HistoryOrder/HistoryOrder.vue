<template>
	<view>
		...
		<view class="order-list">
			<view class="list">
				<view class="onorder" v-if="list==null">
	...
	export default {
		data() {
			return {
				...
				orderList:[
					[
						{ type:"completed",ordersn:0,goods_id: 0, img: '/static/imgs/mianqiu.png', name: '医用酒精棉球', price: '10.00',payment:10.00,freight:12.00,spec:'25粒',numner:1 },
						{ type:"completed",ordersn:1,goods_id: 1, img: '/static/imgs/shui.png', name: '矿泉水', price: '1.00',payment:1.00,freight:12.00,spec:'250ml',numner:1 },
						{ type:"completed",ordersn:2,goods_id: 1, img: '/static/imgs/kouzhao.png', name: 'N95口罩', price: '9.90',payment:9.90,freight:12.00,spec:'5支',numner:1 },
						],
					[
