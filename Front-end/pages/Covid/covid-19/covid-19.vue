<template>
	<view>
		<view v-if="yiQingObj">
			<image :src="setting.top_thumb ? setting.top_thumb : '../../../static/covid/banner2.jpg'" mode="widthFix" style="width: 100%;"></image>
				...
				<view class="solid-bottom padding margin-bottom-lg">
					<view class="flex">
						<view class="flex-sub text-center">
							<view class="cu-avatar lg round" style="background-image:url(../../../static/covid/tool_change.png);" @tap="showModal" data-target="gridModal">
								<text class="text-df" style="margin-top: 170upx;color: #333333;" >切换城市</text>
							</view>
						</view>
						<view class="flex-sub text-center">
							<view class="cu-avatar lg round" style="background-image:url(../../../static/covid/tool_search.png);" @tap="community" data-target="community">
			...
			<!-- <view class="cu-bar tabbar foot shop no-border status_bar2" style="left: 25%;">
	...
	export default {
		data() {
			return {
				...
				xiaoQuData: {},
				setting: {
					top_thumb: '../../../static/covid/banner3.jpg',
					ewm: '../../../static/covid/rank.png',
				},
				modifyTime: '2022.5.13',
				lishi: false,
				beijing: {},
				tags:'',
				modalName: null,
